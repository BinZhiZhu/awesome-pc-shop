...
/**
 * Handles the creation of table `dev_app_users`.
 */
class m191014_145807_create_dev_app_users_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (!app\common\Helper::tableExists('dev_app_users')) {
            $tableOptions = 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC';
            $this->createTable('dev_app_users', [
