...
namespace app\myTemplates\modelCest;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $db = 'db';
    public $ns = 'tests\functional';
    public $path = 'tests\functional';
    public $tableName;
    public $modelClass;
    ...
    public $queryNs = 'tests\functional';
    public $queryClass;
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            Yii::debug('params'.var_export($params,true),__METHOD__);
            $files[] = new CodeFile(
                Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/' . $modelClassName.'Cest' . '.php',
            ...
            if ($queryClassName) {
                ...
                $files[] = new CodeFile(
                    Yii::getAlias('@' . str_replace('\\', '/', $this->queryNs)) . '/' . $queryClassName.'Cest' . '.php',
